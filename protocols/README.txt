This folder contains MRI settings and sample data for multi-parameter mapping (MPM) to be used with the hMRI-toolbox (http://hrmi.info).

Sample dataset
==============
A sample dataset is provided as reference and material for exploring the possibilities and functionalities of the hMRI-toolbox.
The data is compressed into the file hmri_sample_dataset.zip
The according acquisition protocol can be found in hmri_sample_dataset_protocol_800um_64ch.pdf
